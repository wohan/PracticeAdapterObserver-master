 ...
 *
 */
/* Класс покупатель содержит данные о покупателе и методы вводы вывода информации о нем  */
...
public class Buyer {
    ...
    protected Integer id;    // Поле индификатора
    @XmlElement(name = "user_name", required = true)
    protected String userName; // Поле имя пользователя
    @XmlElement(name = "user_pass", required = true)
    protected String userPass; // Поле пароль пользователя
    @XmlElement(required = true)
    protected Integer phone;   // Поле телефон пользователя
