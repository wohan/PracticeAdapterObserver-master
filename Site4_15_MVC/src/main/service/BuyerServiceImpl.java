...
public class BuyerServiceImpl implements main.service.BuyerService {
     ...
     * @return true - если длина слова больше или равна length,
     * false если меньше или больше заданного порога maxLength ,по умолчанию 20.
     */
    public Boolean satisfactionLength(String word, int length){
        word = word.replaceAll(" ", "");
        //int maxLength = 20;
        //if ((length > word.length())&&(word.length() > maxLength))
